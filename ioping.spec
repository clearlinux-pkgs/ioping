...
Version  : 1.2
Release  : 9
URL      : https://github.com/koct9i/ioping/archive/v1.2/ioping-1.2.tar.gz
Source0  : https://github.com/koct9i/ioping/archive/v1.2/ioping-1.2.tar.gz
...
%prep
%setup -q -n ioping-1.2
cd %{_builddir}/ioping-1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609782759
...
cp %{_builddir}/ioping-1.2/LICENSE %{buildroot}/usr/share/package-licenses/ioping/8624bcdae55baeef00cd11d5dfcfa60f68710a02
